...
vi.mock("../memo/write-memo.js", () => ({
  writeMemo: vi.fn().mockResolvedValue({
    ...
    sections: [
      ...
      { name: "why_this_is_happening", markdown: "TestCo cause.", word_count: 2 },
      { name: "what_we_would_change", markdown: "TestCo change.", word_count: 2 },
...
function makeAttempt2Memo(): MarkdownMemo {
  return {
    ...
    sections: [
      ...
      { name: "why_this_is_happening", markdown: "TestCo revised cause.", word_count: 3 },
      { name: "what_we_would_change", markdown: "TestCo revised change.", word_count: 3 },
      { name: "cta", markdown: "Reply to confirm a 20-minute call.", word_count: 6 },
    ],
    markdown:
      "## Observation\n\nTestCo revised observation.\n\n## What this means\n\nTestCo revised meaning.",
    generated_at: new Date().toISOString(),
  };
}
  ...
  it("revise-then-pass: second attempt passes, revision metadata populated", async () => {
    ...
    mockWriter.mockResolvedValueOnce({
      ...
      sections: [
        ...
        { name: "why_this_is_happening", markdown: "Generic cause.", word_count: 2 },
        { name: "what_we_would_change", markdown: "Generic change.", word_count: 2 },
        { name: "cta", markdown: "Reply to this letter.", word_count: 4 },
      ],
      markdown: "## Observation\n\nGeneric observation.",
      generated_at: new Date().toISOString(),
